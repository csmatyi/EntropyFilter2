...
write.table('#Before filter#','stats.txt',append=TRUE,quote=F,col.names=F,row.names=F)
...
write.table('#After filter#','stats.txt',append=TRUE,quote=F,col.names=F,row.names=F)
